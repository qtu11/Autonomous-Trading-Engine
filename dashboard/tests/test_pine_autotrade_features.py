import pytest
from server import calculate_dynamic_lot_size, _positions, _commands, _accounts
...
def test_dynamic_lot_size_scaling_with_equity():
    ...
    try:
        ...
        # BUG FIX (test isolation): restore CẢ _account lẫn _active_login — trước đây
        # để lại srv._account là dict thường + _active_login=None làm các test sau
        # (test_risk_gate) đọc balance sai.
        srv._account = orig_account
        srv._active_login = orig_login
