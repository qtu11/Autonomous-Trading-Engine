...
> chứa cùng nội dung (mirror). Mọi thay đổi port/URL/biến env phải cập nhật cả hai file
> **và các template `.env.example` / `.env.template`** (root, dashboard/, web/, Cloudlocal/).
